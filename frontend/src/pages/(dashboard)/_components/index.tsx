    ...
    <div className="flex h-screen bg-gray-200">
      ...
      <div className="w-64 bg-gray-800">
        <div className="flex items-center justify-center mt-10">
          <img src="https://via.placeholder.com/150" className="h-16 w-16 rounded-full" alt="Avatar" />
        ...
        <nav className="mt-10">
          ...
          <a href="#" className="block py-2 px-4 text-gray-200 hover:bg-gray-700 hover:text-white">Users</a>
